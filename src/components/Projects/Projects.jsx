...
export default function Projects({ project }) {
  return (
    <div className="flex flex-col max-w-lg bg-whitish dark:bg-beige border border-beige dark:border-greenish rounded-lg shadow-lg hover:shadow-beige dark:hover:shadow-night hover:shadow-xl hover:scale-105 duration-300">
